...
The facial_identification  component is a component that calculates the degree of similarity with known facial photos stored in the same directory and outputs the file names of similar images. If there are no similar images, outputs No matches found.
...
|  |  |
----|---- 
| Module Name | facial_identification |
