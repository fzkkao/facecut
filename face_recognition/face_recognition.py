...
"""
 ...
 @brief The face recognition component is a component that calculates the degree of similarity with known facial photos stored in the same directory and outputs the file names of similar images. If there are no similar images, outputs No matches found.
 @date $Date$
...
face_recognition_spec = ["implementation_id", "face_recognition", 
         "type_name",         "face_recognition", 
         "description",       "The face recognition component is a component that calculates the degree of similarity with known facial photos stored in the same directory and outputs the file names of similar images. If there are no similar images, outputs No matches found.", 
         "version",           "1.0.0", 
         "vendor",            "VenderName", 
         "category",          "Category", 
...
# 
# </rtc-template>
class face_recognition(OpenRTM_aist.DataFlowComponentBase):
    ...
    def __init__(self, manager):
        ...
        """
        Port that receives face images to compare with known face images
        """
        ...
        """
        Port to output file names of similar images
        """
    ...
    def onActivated(self, ec_id):
        # 複数の既知の顔画像をロード
        self.known_images = ["19186.jpg", "19202.jpg"]
...
def face_recognitionInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=face_recognition_spec)
    manager.registerFactory(profile,
                            face_recognition,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    face_recognitionInit(manager)
    ...
    # Create a component
    comp = manager.createComponent("face_recognition" + args)
